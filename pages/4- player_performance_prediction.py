...
if submit:
    ...
    cluster_descriptions = {
        ...
        3: "Excellent ball‑strikers (tee to green); good all‑round "
        "but could work on putting.",
        4: "Approach a strength; putting an issue.",
        5: "Many areas need work!",
        6: "Approach play should be the first area to develop.",
        7: "Consistent performer with no major deficiencies; "
        "all metrics roughly equal."
    }
